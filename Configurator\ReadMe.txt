========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Configurator
========================================================================


Diese Configurator-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Configurator-Anwendung bilden.
...
Configurator.h
	...
	Anwendungsklasse CConfiguratorApp.
...
res\Configurator.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Configurator.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Configurator.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ConfiguratorDoc.h, ConfiguratorDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CConfiguratorDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CConfiguratorDoc::Serialize).

ConfiguratorView.h, ConfiguratorView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CConfiguratorView.
    	CConfiguratorView-Objekte werden verwendet, um CConfiguratorDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Configurator.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
